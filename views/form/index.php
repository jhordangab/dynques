...
$js = <<<JS
    ...
    $(document).delegate('.delete-form', 'click', function (e) 
    {
        e.preventDefault();
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card card-outline-plan">
                ...
                <div class="card-body">
                    ...
                    <?= Html::a(Yii::t('app', 'view.create'), ['create'], ['id' => 'btn-form', 'class' => 'btn btn-success btn-default float-right ml-2', 'data-pjax' => 0]); ?>

                    <?= $this->render('_search', ['model' => $searchModel]); ?>

                    <?=  ExportMenu::widget([
                        'dataProvider' => $dataProvider,
                        'filename' => 'Dynques_Formulario_' . date('d_m_Y'),
                        'exportConfig' =>
                            [
